...
UNIT_TEST_DIR     = File.join(Rails.root.to_s, "test/unit"  )
SPEC_MODEL_DIR    = File.join(Rails.root.to_s, "spec/models")
FIXTURES_DIR      = File.join(Rails.root.to_s, "test/fixtures")
SPEC_FIXTURES_DIR = File.join(Rails.root.to_s, "spec/fixtures")
